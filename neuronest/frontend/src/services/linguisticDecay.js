...
const SIMPLIFIED_DIALECTS = {
  ...
  Arunachali: {
    ...
    simplifiedPhrases: {
      play_game: 'Poli',
      check_reminders: 'Yalum ka',
      help: 'Help',
      mood_check: 'Into dung',
      progress: 'Score ka',
      greeting: 'Taga',
      yes: 'Ao',
      no: 'Ma',
    ...
    uiTextSimplification: {
      'Play a Game': 'Poli',
      'Cognitive Games': 'Poli Poli',
      'Pattern Recognition': 'Shape Poli',
      'Daily Routine Recall': 'Kam Poli',
      'Memory Match': 'Yalum Poli',
      'How are you feeling?': 'Into Dung?',
      'Reminders': 'Yalum',
      'Accuracy Over Time': 'Score',
      'Performance by Game': 'Poli Score',
    },
  },
  Khasi: {
    code: 'en-IN',
