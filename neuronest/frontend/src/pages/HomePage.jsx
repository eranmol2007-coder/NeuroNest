                    ...
                    return (
                      <li key={r._id} className="reminder-item">
                        ...
                        <div className="reminder-content">
                          ...
                          <span className="reminder-time">{formatTime(r.time)}</span>
                        </div>
                      </li>
                    );
                  })}
