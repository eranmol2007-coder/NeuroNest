...
const LANG_RESPONSES = {
  ...
  Arunachali: { error: "Mapak, aying ma. Kuli lang.", noIntent: "Tat ma. 'Help' agom.", help: 'Nok agom: "poli poli", "yalum kapa", "poli lap".', couldNotHear: "Tat ma — agom lang.", greeting: 'Aro gabo!', opening: (p) => `${p} nok gabo lap.` },
};
...
const NAV_COMMANDS = [
  ...
  { pattern: /report|progress|score|doing/i, target: '/patient-report', label: 'Report', simplifiedKey: null },
...
export function useVoiceAssistant({ patientId, voiceVolume = 70, language = 'English', onAction, userRole } = {}) {
  ...
  }, [patientId, speak, onAction, getSimplifiedResponse, userRole]);
