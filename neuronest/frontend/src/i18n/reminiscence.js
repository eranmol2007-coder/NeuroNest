const STORY_I18N = {
  ...
  Arunachali: {
    page_title: 'Interactive Dodu (Stories)',
    page_subtitle: 'AI-generated dodu nok life experience gabo.',
    chapters_label: 'Chapter',
    read_aloud: 'Agom tat',
    pause: 'Pause',
    previous: '← Kuli',
    next: 'Next →',
    back_to_stories: '← Dodu kuli',
    chapter_of: 'Chapter {{current}} / {{total}}',
    how_feeling: 'Into dung?',
    how_feeling_after: 'Dodu pakam, into dung?',
    journey_complete: 'Kam pak',
    completion_text: 'Taga. Nok yalum dodu aying bisi.',
    mood_before: 'Before',
    mood_after: 'After',
    explore_more: 'Dodu kapa',
    return_home: 'Nam kuli',
    loading: 'Loading dodu...',
    themes: {
      childhood_home: { title: 'Ome Nam', desc: 'Ome nam yalum.' },
      school_days: { title: 'School Duyu', desc: 'School duyu yalum.' },
      family_festival: { title: 'Aya Festival', desc: 'Aya festival dodu.' },
      first_job: { title: 'First Kam', desc: 'First kam dodu.' },
      wedding_memories: { title: 'Wedding Yalum', desc: 'Wedding dodu.' },
      nature_walks: { title: 'Nature Yalum', desc: 'Nature dodu.' }
    },
    chapters: {
      childhood_home: ['Gate', 'Kitchen', 'Garden', 'Room'],
      school_days: ['School', 'Class', 'Ground', 'Library'],
      family_festival: ['Prep', 'Aya', 'Evening', 'Quiet'],
      first_job: ['Morning', 'Office', 'Friends', 'Success'],
      wedding_memories: ['Prep', 'Ceremony', 'Vows', 'Party'],
      nature_walks: ['Forest', 'River', 'Meadow', 'Sunset']
    },
    chapter_texts: {
      childhood_home: [
        'Nok ome nam gate. Aying bisi. Nam into aying.',
        'Kitchen aying. Aya food aying bisi.',
        'Garden aying bisi. Tree aying.',
        'Room kapa. Ome yalum aying bisi.'
      ],
      school_days: [
        'School gate. Ome yalum aying.',
        'Classroom. Friends yalum aying.',
        'Playground aying bisi.',
        'Library quiet. Book aying.'
      ],
      family_festival: [
        'Festival prep aying.',
        'Aya gabo. Happy bisi.',
        'Evening dance. Aying bisi.',
        'Quiet night. Aya aying bisi.'
      ],
      first_job: [
        'Morning kam. Happy.',
        'Office aying. First day kam.',
        'Friends aying. Kam aying.',
        'Success aying bisi. Happy.'
      ],
      wedding_memories: [
        'Wedding prep aying bisi.',
        'Ceremony aying. Happy.',
        'Vows aying. Aya aying.',
        'Party aying bisi. Dance happy.'
      ],
      nature_walks: [
        'Forest walk. Tree aying.',
        'River water aying bisi.',
        'Meadow grass aying.',
        'Sunset aying bisi. Quiet.'
      ]
    }
  },
};
