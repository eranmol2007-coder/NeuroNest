      ...
      <div className="nav-inner">
        <button onClick={() => navigate(user ? (isCaregiver ? '/caregiver' : '/home') : '/')} className="nav-brand">
          ...
          <div className="nav-brand-text">
            ...
            <span className="nav-brand-tagline">{isCaregiver ? t('nav.caregiver_portal', 'Caregiver Portal') : t('nav.cognitive_care', 'Cognitive Care Platform')}</span>
          </div>
        </button>
        ...
        {user ? (
          <nav className="nav-links" aria-label="Main navigation">
            {user.role === 'caregiver' ? (
              <>
                <NavLink to="/caregiver" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>{t('nav.reports', 'Reports')}</NavLink>
                <NavLink to="/caregiver/stories" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>{t('nav.stories', 'Stories')}</NavLink>
              ...
              <>
                ...
                <NavLink to="/reminiscence" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>{t('nav.stories', 'Stories')}</NavLink>
                ...
                <NavLink to="/patient-report" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>{t('nav.report', 'Report')}</NavLink>
                <NavLink to="/settings" className={({ isActive }) => `nav-link${isActive ? ' active' : ''}`}>{t('nav.settings')}</NavLink>
              </>
            )}
