...
import arunachali from '../i18n/arunachali.json';
import { usePatient } from './PatientContext.jsx';
import { decayDetector, SIMPLIFIED_DIALECTS } from '../services/linguisticDecay';

const LANG_MAP = { English: en, Assamese: as, Bengali: bn, Hindi: hi, Khasi: kha, Mizo: mzo, Nagamese: nagamese, Manipuri: mni, Arunachali: arunachali };
